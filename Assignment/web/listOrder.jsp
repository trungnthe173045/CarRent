                                    ...
                                    <c:forEach var="od" items="${requestScope.listOd}">
                                        <tr class="align-content-between">
                                            ...
                                            <td>${od.car.price*od.order.rental_hours} $</td>
                                                ...
                                                <td>
                                                    <a href="listOrder?id=${od.order.id}&ac=true"><button type="button" class="btn btn-primary edit-btn">Accept</button></a>  
                                                    <a href="listOrder?id=${od.order.id}&ac=false"><button type="button" class="btn btn-danger delete-btn" id="removeBtn">X</button></a>
                                                </td>
