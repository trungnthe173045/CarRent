...
<html>
    <head>
        ...
        <!-- comment --><link rel="stylesheet" href="css/datetimepicker.css">
        ...
        <style>
            ...
            .time-input {
                ...
                max-height: 100px; /* Set maximum height for scrollbar */
            }
    ...
    <body>
        ...
        <div class="row">
            <div class="col-12 mb-3 mb-lg-"> 
                <c:set var="c" value="${requestScope.car}"/>
                            ...
                            <div>
                                ...
                                <div class="modal-body">
                                    <!-- Form content here -->
                                        ...
                                        <div >
                                            <label >Car ID</label>
                                            <input type="text" class="form-control" id="centeredInput" name="carid" value="${c.id}" readonly >
                                        </div>

                                        <div class="form-group">
                                            <label >Car Name</label>
                                            <input type="text" class="form-control" id="centeredInput" name="name" value="${c.name}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Pick Up Location</label>
                                            <input type="text" class="form-control" id="centeredInput" name="pick_up_location">
                                        </div>
                                        <div class="form-group">
                                            <label >Drop Off Location</label>
                                            <input type="text" class="form-control" id="centeredInput" name="drop_off_location" >
                                        </div>

                                        <div class="form-group">
                                            <label >Pick Up Date</label>
                                            <input type="date" class="form-control" id="centeredInput" name="pick_up_date">
                                        </div>

                                        <div class="form-group">
                                            <label >Drop Off Date</label>
                                            <input type="date" class="form-control" id="centeredInput" name="drop_off_date">
                                        </div>

                                        <div class="form-group">
                                            <label >Pick Up Time</label>
                                            <input type="time" class="form-control" id="centeredInput" name="pick_up_time">

                                        </div>

                                        <div class="form-group">
                                            <label >Drop Off Time</label>
                                            <input type="time" class="form-control" id="centeredInput" name="drop_off_time">
                                        </div>
                                ...
                                <input type="submit" value="Order" class="form-control" id="centeredInput">
